...
13. Tambah soal kuis dan fun fact baru agar mencakup seluruh materi Capaian Pembelajaran (CP) yang relevan, bukan hanya 42 soal yang sudah ada. Acuan: docs/CAKUPAN-CP-TP.md — fokuskan konten baru HANYA untuk menutup TP1 (sejarah sistem periodik, via Fun Fact baru) dan TP2 (tren jari-jari atom/energi ionisasi/keelektronegatifan, via soal kuis baru) dari dokumen CP-TP_Sistem_Periodik_Unsur.md. Materi konfigurasi elektron dasar sudah dihapus sepenuhnya dari alur TP — tidak lagi digamifikasi maupun ditampilkan. TP3 dan TP4 sudah tercakup oleh mekanik inti game dan Fun Fact yang ada.
